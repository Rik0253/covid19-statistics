  ...
  render() {
    return (
      <footer className="py-6 bg-coolGray-100 text-coolGray-900"> 
        <hr />      
         <div className="space-y-6 divide-y divide-gray-400 md:space-y-12 divide-opacity-50"></div>
          <div className="grid justify-center pt-6 lg:justify-between">
            <div className="flex flex-col self-center text-sm text-center md:block lg:col-start-1 md:space-x-6">
              <span>Made with ❤️ ©2021 All rights reserved</span>
              {/* <a href="#">
            ...
            <div className="flex justify-center pt-4 space-x-4 lg:pt-0 lg:col-end-13">
              <a
                href="mailto:das.sidd89@gmail.com"               
